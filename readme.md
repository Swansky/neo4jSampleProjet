...
### Ajout d'un noeud d'une entreprise
...
-- Avec l'index sur le nom de la compagnie pour optimiser les requêtes
...
-- Avec l'index sur le nom de l'utilisateur pour optimiser les requêtes
